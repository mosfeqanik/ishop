...
class TextThemes {
  ...
  static final TextStyle blackPreview =
      TextStyle(fontFamily: "Solway", fontSize: 13, color: Colors.black);
  ...
  static final TextStyle darkRedMediumNewS = TextStyle(
      fontFamily: "Solway",
      fontSize: 16,
      color: Color.fromRGBO(255, 107, 102, 1.0));
  ...
  static final TextStyle kSmallTextBlack = TextStyle(
    fontFamily: "Solway",
    fontSize: 14,
      letterSpacing: 0.5,
    color: Colors.black,
  ...
  static final TextStyle kHomeTextStyleTitle = TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.bold,
    color:  AppColors.kTenBlackColor,
  );
